 ...
 * @generated
 */
public class UmlContract2javaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case UmlContract2javaPackage.CORR_RULE: {
			CorrRule corrRule = (CorrRule) theEObject;
			T result = caseCorrRule(corrRule);
			if (result == null)
				result = caseTGGNode(corrRule);
			if (result == null)
				result = caseMLAnnotatedElement(corrRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Corr Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Corr Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCorrRule(CorrRule object) {
		return null;
	}
