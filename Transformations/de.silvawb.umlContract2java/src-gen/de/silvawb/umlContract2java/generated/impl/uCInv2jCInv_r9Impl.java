...
import de.silvawb.umlContract2java.generated.uCInv2jCInv_r9;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>uC Inv2j CInv r9</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getConflictCheckForwardActivity <em>Conflict Check Forward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getConflictCheckMappingActivity <em>Conflict Check Mapping Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getConflictCheckBackwardActivity <em>Conflict Check Backward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getRepairForwardActivity <em>Repair Forward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlContract2java.generated.impl.uCInv2jCInv_r9Impl#getRepairBackwardActivity <em>Repair Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class uCInv2jCInv_r9Impl extends OperationalRuleImpl implements uCInv2jCInv_r9 {
	/**
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.eINSTANCE.getuCInv2jCInv_r9();
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__ADD_ELEMENT_ACTIVITY, oldAddElementActivity,
							addElementActivity));
			}
		}
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__MOVE_ELEMENT_ACTIVITY, oldMoveElementActivity,
							moveElementActivity));
			}
		}
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__CHANGE_ATTRIBUTE_ACTIVITY, oldChangeAttributeActivity,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__TRANSFORM_FORWARD_ACTIVITY, oldTransformForwardActivity,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__TRANSFORM_MAPPING_ACTIVITY, oldTransformMappingActivity,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__TRANSFORM_BACKWARD_ACTIVITY,
	...
	public void setTransformBackwardActivity(Activity newTransformBackwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UC_INV2J_CINV_R9__TRANSFORM_BACKWARD_ACTIVITY, oldTransformBackwardActivity,
	...
	public Activity getConflictCheckForwardActivity() {
		if (conflictCheckForwardActivity != null && conflictCheckForwardActivity.eIsProxy()) {
			...
			if (conflictCheckForwardActivity != oldConflictCheckForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__CONFLICT_CHECK_FORWARD_ACTIVITY,
	...
	public void setConflictCheckForwardActivity(Activity newConflictCheckForwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UC_INV2J_CINV_R9__CONFLICT_CHECK_FORWARD_ACTIVITY, oldConflictCheckForwardActivity,
	...
	public Activity getConflictCheckMappingActivity() {
		if (conflictCheckMappingActivity != null && conflictCheckMappingActivity.eIsProxy()) {
			...
			if (conflictCheckMappingActivity != oldConflictCheckMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__CONFLICT_CHECK_MAPPING_ACTIVITY,
	...
	public void setConflictCheckMappingActivity(Activity newConflictCheckMappingActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UC_INV2J_CINV_R9__CONFLICT_CHECK_MAPPING_ACTIVITY, oldConflictCheckMappingActivity,
	...
	public Activity getConflictCheckBackwardActivity() {
		if (conflictCheckBackwardActivity != null && conflictCheckBackwardActivity.eIsProxy()) {
			...
			if (conflictCheckBackwardActivity != oldConflictCheckBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__CONFLICT_CHECK_BACKWARD_ACTIVITY,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__SYNCHRONIZE_FORWARD_ACTIVITY,
	...
	public void setSynchronizeForwardActivity(Activity newSynchronizeForwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UC_INV2J_CINV_R9__SYNCHRONIZE_FORWARD_ACTIVITY, oldSynchronizeForwardActivity,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public void setSynchronizeBackwardActivity(Activity newSynchronizeBackwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UC_INV2J_CINV_R9__SYNCHRONIZE_BACKWARD_ACTIVITY, oldSynchronizeBackwardActivity,
	...
	public Activity getRepairForwardActivity() {
		if (repairForwardActivity != null && repairForwardActivity.eIsProxy()) {
			...
			if (repairForwardActivity != oldRepairForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__REPAIR_FORWARD_ACTIVITY, oldRepairForwardActivity,
	...
	public Activity getRepairBackwardActivity() {
		if (repairBackwardActivity != null && repairBackwardActivity.eIsProxy()) {
			...
			if (repairBackwardActivity != oldRepairBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UC_INV2J_CINV_R9__REPAIR_BACKWARD_ACTIVITY, oldRepairBackwardActivity,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GeneratedPackage.UC_INV2J_CINV_R9___ADD_ELEMENT__EMAP:
			return addElement((EMap<String, Object>) arguments.get(0));
		case GeneratedPackage.UC_INV2J_CINV_R9___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0), (EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.UC_INV2J_CINV_R9___MOVE_ELEMENT__TGGNODE_TGGNODE_TGGNODE:
			return moveElement((TGGNode) arguments.get(0), (TGGNode) arguments.get(1), (TGGNode) arguments.get(2));
		case GeneratedPackage.UC_INV2J_CINV_R9___TRANSFORM_FORWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.UC_INV2J_CINV_R9___TRANSFORM_MAPPING__TGGNODE_BOOLEAN_BOOLEAN:
			return transformMapping((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.UC_INV2J_CINV_R9___TRANSFORM_BACKWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.UC_INV2J_CINV_R9___CONFLICT_CHECK_FORWARD__TGGNODE:
			return conflictCheckForward((TGGNode) arguments.get(0));
		case GeneratedPackage.UC_INV2J_CINV_R9___CONFLICT_CHECK_MAPPING__TGGNODE:
			return conflictCheckMapping((TGGNode) arguments.get(0));
		case GeneratedPackage.UC_INV2J_CINV_R9___CONFLICT_CHECK_BACKWARD__TGGNODE:
			return conflictCheckBackward((TGGNode) arguments.get(0));
		case GeneratedPackage.UC_INV2J_CINV_R9___SYNCHRONIZE_FORWARD__TGGNODE_BOOLEAN:
			return synchronizeForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.UC_INV2J_CINV_R9___SYNCHRONIZE_BACKWARD__TGGNODE_BOOLEAN:
			return synchronizeBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.UC_INV2J_CINV_R9___REPAIR_FORWARD__TGGNODE_BOOLEAN:
			return repairForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.UC_INV2J_CINV_R9___REPAIR_BACKWARD__TGGNODE_BOOLEAN:
