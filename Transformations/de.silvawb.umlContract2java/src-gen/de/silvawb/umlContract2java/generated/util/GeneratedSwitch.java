...
public class GeneratedSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case GeneratedPackage.UO_INV2J_MA_INV: {
			uOInv2jMAInv uOInv2jMAInv = (uOInv2jMAInv) theEObject;
			T result = caseuOInv2jMAInv(uOInv2jMAInv);
			if (result == null)
				result = caseOperationalRuleGroup(uOInv2jMAInv);
			if (result == null)
				result = caseOperationalMappingGroup(uOInv2jMAInv);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case GeneratedPackage.UO_INV2J_MA_INV_R11: {
			uOInv2jMAInv_r11 uOInv2jMAInv_r11 = (uOInv2jMAInv_r11) theEObject;
			T result = caseuOInv2jMAInv_r11(uOInv2jMAInv_r11);
			if (result == null)
				result = caseOperationalRule(uOInv2jMAInv_r11);
			if (result == null)
				result = caseOperationalMapping(uOInv2jMAInv_r11);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>uO Inv2j MA Inv</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>uO Inv2j MA Inv</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseuOInv2jMAInv(uOInv2jMAInv object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>uO Inv2j MA Inv r11</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>uO Inv2j MA Inv r11</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseuOInv2jMAInv_r11(uOInv2jMAInv_r11 object) {
		return null;
	}
