...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>uml Interaction2java Axiom r1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.silvawb.umlInteraction2java.generated.impl.umlInteraction2javaAxiom_r1Impl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class umlInteraction2javaAxiom_r1Impl extends OperationalAxiomImpl implements umlInteraction2javaAxiom_r1 {
	/**
	 ...
	 * @generated
	 */
	protected umlInteraction2javaAxiom_r1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.UML_INTERACTION2JAVA_AXIOM_R1;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__ADD_ELEMENT_ACTIVITY, oldAddElementActivity,
							addElementActivity));
			}
		}
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__MOVE_ELEMENT_ACTIVITY,
	...
	public void setMoveElementActivity(Activity newMoveElementActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__MOVE_ELEMENT_ACTIVITY, oldMoveElementActivity,
					moveElementActivity));
	}
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__CHANGE_ATTRIBUTE_ACTIVITY,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__TRANSFORM_FORWARD_ACTIVITY,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__TRANSFORM_MAPPING_ACTIVITY,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__TRANSFORM_BACKWARD_ACTIVITY,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__SYNCHRONIZE_FORWARD_ACTIVITY,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public TGGNode addElement(final EMap<String, Object> parameters, final EList<EObject> leftInputElements,
		...
		((de.silvawb.umlInteraction2java.generated.umlInteraction2javaOperationalTGG) this.getOperationalAxiomGroup()
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1___ADD_ELEMENT__EMAP_ELIST_ELIST:
			return addElement((EMap<String, Object>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(EList<EObject>) arguments.get(2));
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0), (EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1___TRANSFORM_FORWARD__ELIST_ELIST_BOOLEAN:
			return transformForward((EList<EObject>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1___TRANSFORM_MAPPING__ELIST_ELIST_BOOLEAN:
			return transformMapping((EList<EObject>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1___TRANSFORM_BACKWARD__ELIST_ELIST_BOOLEAN:
			return transformBackward((EList<EObject>) arguments.get(0), (EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1___SYNCHRONIZE_FORWARD__ELIST_ELIST_TGGNODE_BOOLEAN:
		...
		case GeneratedPackage.UML_INTERACTION2JAVA_AXIOM_R1___SYNCHRONIZE_BACKWARD__ELIST_ELIST_TGGNODE_BOOLEAN:
...
} //umlInteraction2javaAxiom_r1Impl
