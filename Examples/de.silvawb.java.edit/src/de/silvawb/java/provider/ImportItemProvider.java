...
/**
 * This is the item provider adapter for a {@link de.silvawb.java.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_imported_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_imported_feature", "_UI_Import_type"),
				 JavaPackage.Literals.IMPORT__IMPORTED,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_name_feature", "_UI_Import_type"),
				 JavaPackage.Literals.IMPORT__NAME,
				 true,
				 false,
				 false,
