	...
	protected void addOrderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Argument_order_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Argument_order_feature", "_UI_Argument_type"),
				 JavaPackage.Literals.ARGUMENT__ORDER,
				 true,
				 false,
				 false,
