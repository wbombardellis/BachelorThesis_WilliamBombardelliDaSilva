...
/**
 * This is the item provider adapter for a {@link de.silvawb.java.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JavaPackage.Literals.PACKAGE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((de.silvawb.java.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(de.silvawb.java.Package.class)) {
