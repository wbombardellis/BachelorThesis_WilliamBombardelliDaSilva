...
public class ClassifierItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.Literals.CLASSIFIER__GENERALIZATION);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.Literals.CLASSIFIER__GENERIC_BINDINGS,
				 JavaFactory.eINSTANCE.createGenericBinding()));
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.Literals.CLASSIFIER__GENERALIZATION,
