...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Uml Package2 Java Package r2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getConflictCheckForwardActivity <em>Conflict Check Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getConflictCheckMappingActivity <em>Conflict Check Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getConflictCheckBackwardActivity <em>Conflict Check Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getRepairForwardActivity <em>Repair Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.UmlClassDiagram2Java.generated.impl.UmlPackage2JavaPackage_r2Impl#getRepairBackwardActivity <em>Repair Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UmlPackage2JavaPackage_r2Impl extends OperationalRuleImpl implements UmlPackage2JavaPackage_r2 {
	/**
	 ...
	 * @generated
	 */
	protected UmlPackage2JavaPackage_r2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.UML_PACKAGE2_JAVA_PACKAGE_R2;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__ADD_ELEMENT_ACTIVITY, oldAddElementActivity,
							addElementActivity));
			}
		}
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__MOVE_ELEMENT_ACTIVITY,
	...
	public void setMoveElementActivity(Activity newMoveElementActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__MOVE_ELEMENT_ACTIVITY, oldMoveElementActivity,
					moveElementActivity));
	}
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CHANGE_ATTRIBUTE_ACTIVITY,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__TRANSFORM_FORWARD_ACTIVITY,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__TRANSFORM_MAPPING_ACTIVITY,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__TRANSFORM_BACKWARD_ACTIVITY,
	...
	public Activity getConflictCheckForwardActivity() {
		if (conflictCheckForwardActivity != null && conflictCheckForwardActivity.eIsProxy()) {
			...
			if (conflictCheckForwardActivity != oldConflictCheckForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CONFLICT_CHECK_FORWARD_ACTIVITY,
	...
	public Activity getConflictCheckMappingActivity() {
		if (conflictCheckMappingActivity != null && conflictCheckMappingActivity.eIsProxy()) {
			...
			if (conflictCheckMappingActivity != oldConflictCheckMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CONFLICT_CHECK_MAPPING_ACTIVITY,
	...
	public Activity getConflictCheckBackwardActivity() {
		if (conflictCheckBackwardActivity != null && conflictCheckBackwardActivity.eIsProxy()) {
			...
			if (conflictCheckBackwardActivity != oldConflictCheckBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CONFLICT_CHECK_BACKWARD_ACTIVITY,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__SYNCHRONIZE_FORWARD_ACTIVITY,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public Activity getRepairForwardActivity() {
		if (repairForwardActivity != null && repairForwardActivity.eIsProxy()) {
			...
			if (repairForwardActivity != oldRepairForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__REPAIR_FORWARD_ACTIVITY,
	...
	public void setRepairForwardActivity(Activity newRepairForwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__REPAIR_FORWARD_ACTIVITY, oldRepairForwardActivity,
	...
	public Activity getRepairBackwardActivity() {
		if (repairBackwardActivity != null && repairBackwardActivity.eIsProxy()) {
			...
			if (repairBackwardActivity != oldRepairBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__REPAIR_BACKWARD_ACTIVITY,
	...
	public void setRepairBackwardActivity(Activity newRepairBackwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__REPAIR_BACKWARD_ACTIVITY, oldRepairBackwardActivity,
	...
	public TGGNode addElement(final EMap<String, Object> parameters) throws TransformationException {
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getAddElementActivity(),
						parametersCopy);
	...
	public boolean changeAttributeValues(final TGGNode correspondenceNode, final EMap<String, Object> ruleParameters)
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getChangeAttributeActivity(),
						params);
	...
	public boolean moveElement(final TGGNode correspondenceNode, final TGGNode oldPreviousCorrespondenceNode,
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getMoveElementActivity(), params);
	...
	public ErrorCodeEnum transformForward(final TGGNode inputTggNode, final boolean checkAttributeFormulae,
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getTransformForwardActivity(),
						parameters);
	...
	public ErrorCodeEnum transformMapping(final TGGNode inputTggNode, final boolean checkAttributeFormulae,
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getTransformMappingActivity(),
						parameters);
	...
	public ErrorCodeEnum transformBackward(final TGGNode inputTggNode, final boolean checkAttributeFormulae,
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getTransformBackwardActivity(),
						parameters);
	...
	public EList<EObject> conflictCheckForward(final TGGNode inputTggNode) throws TransformationException {
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getConflictCheckForwardActivity(),
						parameters);
	...
	public EList<EObject> conflictCheckMapping(final TGGNode inputTggNode) throws TransformationException {
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getConflictCheckMappingActivity(),
						parameters);
	...
	public EList<EObject> conflictCheckBackward(final TGGNode inputTggNode) throws TransformationException {
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getConflictCheckBackwardActivity(),
						parameters);
	...
	public ErrorCodeEnum synchronizeForward(final TGGNode inputTggNode, final boolean checkAttributeFormulae)
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getSynchronizeForwardActivity(),
						parameters);
	...
	public ErrorCodeEnum synchronizeBackward(final TGGNode inputTggNode, final boolean checkAttributeFormulae)
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getSynchronizeBackwardActivity(),
						parameters);
	...
	public ErrorCodeEnum repairForward(final TGGNode inputTggNode, final boolean checkAttributeFormulae)
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getRepairForwardActivity(),
						parameters);
	...
	public ErrorCodeEnum repairBackward(final TGGNode inputTggNode, final boolean checkAttributeFormulae)
		...
		((de.mdelab.mltgg.UmlClassDiagram2Java.generated.UmlClassDiagram2JavaOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG()).executeActivity(this.getRepairBackwardActivity(),
						parameters);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CONFLICT_CHECK_FORWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckForwardActivity();
			return basicGetConflictCheckForwardActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CONFLICT_CHECK_MAPPING_ACTIVITY:
			if (resolve)
				return getConflictCheckMappingActivity();
			return basicGetConflictCheckMappingActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__CONFLICT_CHECK_BACKWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckBackwardActivity();
			return basicGetConflictCheckBackwardActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeBackwardActivity();
			return basicGetSynchronizeBackwardActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__REPAIR_FORWARD_ACTIVITY:
			if (resolve)
				return getRepairForwardActivity();
			return basicGetRepairForwardActivity();
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2__REPAIR_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___ADD_ELEMENT__EMAP:
			return addElement((EMap<String, Object>) arguments.get(0));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0), (EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___MOVE_ELEMENT__TGGNODE_TGGNODE_TGGNODE:
			return moveElement((TGGNode) arguments.get(0), (TGGNode) arguments.get(1), (TGGNode) arguments.get(2));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___TRANSFORM_FORWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___TRANSFORM_MAPPING__TGGNODE_BOOLEAN_BOOLEAN:
			return transformMapping((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___TRANSFORM_BACKWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___CONFLICT_CHECK_FORWARD__TGGNODE:
			return conflictCheckForward((TGGNode) arguments.get(0));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___CONFLICT_CHECK_MAPPING__TGGNODE:
			return conflictCheckMapping((TGGNode) arguments.get(0));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___CONFLICT_CHECK_BACKWARD__TGGNODE:
			return conflictCheckBackward((TGGNode) arguments.get(0));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___SYNCHRONIZE_FORWARD__TGGNODE_BOOLEAN:
			return synchronizeForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___SYNCHRONIZE_BACKWARD__TGGNODE_BOOLEAN:
			return synchronizeBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___REPAIR_FORWARD__TGGNODE_BOOLEAN:
			return repairForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.UML_PACKAGE2_JAVA_PACKAGE_R2___REPAIR_BACKWARD__TGGNODE_BOOLEAN:
			return repairBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //UmlPackage2JavaPackage_r2Impl
