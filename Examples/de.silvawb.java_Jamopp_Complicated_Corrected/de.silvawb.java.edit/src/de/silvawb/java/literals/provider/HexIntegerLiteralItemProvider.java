...
/**
 * This is the item provider adapter for a {@link de.silvawb.java.literals.HexIntegerLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HexIntegerLiteralItemProvider extends IntegerLiteralItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HexIntegerLiteral_hexValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HexIntegerLiteral_hexValue_feature", "_UI_HexIntegerLiteral_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_HexIntegerLiteral_type") :
