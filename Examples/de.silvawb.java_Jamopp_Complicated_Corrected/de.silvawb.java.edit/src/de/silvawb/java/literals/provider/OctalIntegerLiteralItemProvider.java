...
/**
 * This is the item provider adapter for a {@link de.silvawb.java.literals.OctalIntegerLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OctalIntegerLiteralItemProvider extends IntegerLiteralItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_OctalIntegerLiteral_octalValue_feature", "_UI_OctalIntegerLiteral_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_OctalIntegerLiteral_type") :
