/**
 */
package de.silvawb.java.containers.provider;
...
/**
 * This is the item provider adapter for a {@link de.silvawb.java.containers.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider extends JavaRootItemProvider {
	...
	public String getText(Object object) {
		String label = ((de.silvawb.java.containers.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(de.silvawb.java.containers.Package.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ContainersPackage.Literals.PACKAGE__COMPILATION_UNITS,
