 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.literals.impl.HexLongLiteralImpl#getHexValue <em>Hex Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HexLongLiteralImpl extends LongLiteralImpl implements HexLongLiteral {
	...
	public void setHexValue(BigInteger newHexValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LiteralsPackage.HEX_LONG_LITERAL__HEX_VALUE, oldHexValue, hexValue));
	}
