 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.classifiers.impl.ClassifierImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case ClassifiersPackage.CLASSIFIER__NAME: return CommonsPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case CommonsPackage.NAMED_ELEMENT__NAME: return ClassifiersPackage.CLASSIFIER__NAME;
				default: return -1;
			}
		}
		if (baseClass == ReferenceableElement.class) {
