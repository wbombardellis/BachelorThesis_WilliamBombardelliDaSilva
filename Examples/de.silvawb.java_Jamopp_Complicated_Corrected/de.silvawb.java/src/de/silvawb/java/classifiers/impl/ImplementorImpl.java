 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.classifiers.impl.ImplementorImpl#getImplements <em>Implements</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ImplementorImpl extends CommentableImpl implements Implementor {
	...
	public EList<TypeReference> getImplements() {
		if (implements_ == null) {
			implements_ = new EObjectContainmentEList<TypeReference>(TypeReference.class, this, ClassifiersPackage.IMPLEMENTOR__IMPLEMENTS);
		}
		return implements_;
	}
