 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.annotations.impl.AnnotableImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AnnotableImpl extends CommentableImpl implements Annotable {
	...
	public EList<AnnotationInstance> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<AnnotationInstance>(AnnotationInstance.class, this, AnnotationsPackage.ANNOTABLE__ANNOTATIONS);
		}
		return annotations;
	}
