 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.statements.impl.TryBlockImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link de.silvawb.java.statements.impl.TryBlockImpl#getCatcheBlocks <em>Catche Blocks</em>}</li>
 *   <li>{@link de.silvawb.java.statements.impl.TryBlockImpl#getFinallyBlock <em>Finally Block</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TryBlockImpl extends StatementImpl implements TryBlock {
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, StatementsPackage.TRY_BLOCK__STATEMENTS);
		}
		return statements;
	}
	...
	public EList<CatchBlock> getCatcheBlocks() {
		if (catcheBlocks == null) {
			catcheBlocks = new EObjectContainmentEList<CatchBlock>(CatchBlock.class, this, StatementsPackage.TRY_BLOCK__CATCHE_BLOCKS);
		}
		return catcheBlocks;
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (baseOperationID) {
				case StatementsPackage.STATEMENT_LIST_CONTAINER___GET_LOCAL_VARIABLE__STRING: return StatementsPackage.TRY_BLOCK___GET_LOCAL_VARIABLE__STRING;
				default: return -1;
			}
		}
