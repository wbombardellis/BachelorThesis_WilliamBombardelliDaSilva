 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.statements.impl.SynchronizedBlockImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link de.silvawb.java.statements.impl.SynchronizedBlockImpl#getLockProvider <em>Lock Provider</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SynchronizedBlockImpl extends StatementImpl implements SynchronizedBlock {
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, StatementsPackage.SYNCHRONIZED_BLOCK__STATEMENTS);
		}
		return statements;
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (baseOperationID) {
				case StatementsPackage.STATEMENT_LIST_CONTAINER___GET_LOCAL_VARIABLE__STRING: return StatementsPackage.SYNCHRONIZED_BLOCK___GET_LOCAL_VARIABLE__STRING;
				default: return -1;
			}
		}
