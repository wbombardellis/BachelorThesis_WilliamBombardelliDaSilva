 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.statements.TryBlock#getCatcheBlocks <em>Catche Blocks</em>}</li>
 *   <li>{@link de.silvawb.java.statements.TryBlock#getFinallyBlock <em>Finally Block</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.statements.StatementsPackage#getTryBlock()
 * @model
 * @generated
 */
public interface TryBlock extends Statement, StatementListContainer {
	 ...
	 * The list contents are of type {@link de.silvawb.java.statements.CatchBlock}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.silvawb.java.statements.StatementsPackage#getTryBlock_CatcheBlocks()
	 ...
	 * @see de.silvawb.java.statements.StatementsPackage#getTryBlock_FinallyBlock()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.statements.TryBlock#getFinallyBlock <em>Finally Block</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
