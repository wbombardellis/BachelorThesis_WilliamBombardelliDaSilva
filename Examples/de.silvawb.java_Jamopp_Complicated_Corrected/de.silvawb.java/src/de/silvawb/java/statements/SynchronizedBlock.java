 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.statements.SynchronizedBlock#getLockProvider <em>Lock Provider</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.statements.StatementsPackage#getSynchronizedBlock()
 * @model
 * @generated
 */
public interface SynchronizedBlock extends Statement, StatementListContainer {
	 ...
	 * @see de.silvawb.java.statements.StatementsPackage#getSynchronizedBlock_LockProvider()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.statements.SynchronizedBlock#getLockProvider <em>Lock Provider</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
