 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.statements.impl.ForLoopImpl#getStatement <em>Statement</em>}</li>
 *   <li>{@link de.silvawb.java.statements.impl.ForLoopImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link de.silvawb.java.statements.impl.ForLoopImpl#getInit <em>Init</em>}</li>
 *   <li>{@link de.silvawb.java.statements.impl.ForLoopImpl#getUpdates <em>Updates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForLoopImpl extends StatementImpl implements ForLoop {
	...
	public EList<Expression> getUpdates() {
		if (updates == null) {
			updates = new EObjectContainmentEList<Expression>(Expression.class, this, StatementsPackage.FOR_LOOP__UPDATES);
		}
		return updates;
	}
