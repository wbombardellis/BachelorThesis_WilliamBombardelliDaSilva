 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.types.impl.TypedElementImpl#getTypeReference <em>Type Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TypedElementImpl extends CommentableImpl implements TypedElement {
	...
	public NotificationChain basicSetTypeReference(TypeReference newTypeReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE, oldTypeReference, newTypeReference);
	...
	public void setTypeReference(TypeReference newTypeReference) {
		if (newTypeReference != typeReference) {
			...
			if (typeReference != null)
				msgs = ((InternalEObject)typeReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE, null, msgs);
			if (newTypeReference != null)
				msgs = ((InternalEObject)newTypeReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE, null, msgs);
			msgs = basicSetTypeReference(newTypeReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE, newTypeReference, newTypeReference));
	}
