 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.imports.impl.ImportingElementImpl#getImports <em>Imports</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ImportingElementImpl extends CommentableImpl implements ImportingElement {
	...
	public EList<Import> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<Import>(Import.class, this, ImportsPackage.IMPORTING_ELEMENT__IMPORTS);
		}
		return imports;
	}
