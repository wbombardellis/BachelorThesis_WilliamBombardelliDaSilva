 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.expressions.impl.EqualityExpressionImpl#getEqualityOperators <em>Equality Operators</em>}</li>
 *   <li>{@link de.silvawb.java.expressions.impl.EqualityExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualityExpressionImpl extends AndExpressionChildImpl implements EqualityExpression {
	...
	public EList<EqualityOperator> getEqualityOperators() {
		if (equalityOperators == null) {
			equalityOperators = new EObjectContainmentEList<EqualityOperator>(EqualityOperator.class, this, ExpressionsPackage.EQUALITY_EXPRESSION__EQUALITY_OPERATORS);
		}
	...
	public EList<EqualityExpressionChild> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<EqualityExpressionChild>(EqualityExpressionChild.class, this, ExpressionsPackage.EQUALITY_EXPRESSION__CHILDREN);
		}
		return children;
	}
