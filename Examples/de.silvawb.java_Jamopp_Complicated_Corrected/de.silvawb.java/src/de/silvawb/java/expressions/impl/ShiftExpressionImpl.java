 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.expressions.impl.ShiftExpressionImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link de.silvawb.java.expressions.impl.ShiftExpressionImpl#getShiftOperators <em>Shift Operators</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShiftExpressionImpl extends RelationExpressionChildImpl implements ShiftExpression {
	...
	public EList<ShiftExpressionChild> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<ShiftExpressionChild>(ShiftExpressionChild.class, this, ExpressionsPackage.SHIFT_EXPRESSION__CHILDREN);
		}
		return children;
	}
	...
	public EList<ShiftOperator> getShiftOperators() {
		if (shiftOperators == null) {
			shiftOperators = new EObjectContainmentEList<ShiftOperator>(ShiftOperator.class, this, ExpressionsPackage.SHIFT_EXPRESSION__SHIFT_OPERATORS);
		}
