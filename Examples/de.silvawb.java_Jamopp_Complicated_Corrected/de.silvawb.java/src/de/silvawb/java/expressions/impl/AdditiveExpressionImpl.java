 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.expressions.impl.AdditiveExpressionImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link de.silvawb.java.expressions.impl.AdditiveExpressionImpl#getAdditiveOperators <em>Additive Operators</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditiveExpressionImpl extends ShiftExpressionChildImpl implements AdditiveExpression {
	...
	public EList<AdditiveExpressionChild> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<AdditiveExpressionChild>(AdditiveExpressionChild.class, this, ExpressionsPackage.ADDITIVE_EXPRESSION__CHILDREN);
		}
		return children;
	}
	...
	public EList<AdditiveOperator> getAdditiveOperators() {
		if (additiveOperators == null) {
			additiveOperators = new EObjectContainmentEList<AdditiveOperator>(AdditiveOperator.class, this, ExpressionsPackage.ADDITIVE_EXPRESSION__ADDITIVE_OPERATORS);
		}
