 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.expressions.impl.ConditionalAndExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalAndExpressionImpl extends ConditionalOrExpressionChildImpl implements ConditionalAndExpression {
	...
	public EList<ConditionalAndExpressionChild> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<ConditionalAndExpressionChild>(ConditionalAndExpressionChild.class, this, ExpressionsPackage.CONDITIONAL_AND_EXPRESSION__CHILDREN);
		}
		return children;
	}
