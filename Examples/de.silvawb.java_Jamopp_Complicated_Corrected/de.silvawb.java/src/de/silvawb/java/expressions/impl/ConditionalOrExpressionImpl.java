 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.expressions.impl.ConditionalOrExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalOrExpressionImpl extends ConditionalExpressionChildImpl implements ConditionalOrExpression {
	...
	public EList<ConditionalOrExpressionChild> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<ConditionalOrExpressionChild>(ConditionalOrExpressionChild.class, this, ExpressionsPackage.CONDITIONAL_OR_EXPRESSION__CHILDREN);
		}
		return children;
	}
