 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.expressions.impl.AndExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndExpressionImpl extends ExclusiveOrExpressionChildImpl implements AndExpression {
	...
	public EList<AndExpressionChild> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<AndExpressionChild>(AndExpressionChild.class, this, ExpressionsPackage.AND_EXPRESSION__CHILDREN);
		}
		return children;
	}
