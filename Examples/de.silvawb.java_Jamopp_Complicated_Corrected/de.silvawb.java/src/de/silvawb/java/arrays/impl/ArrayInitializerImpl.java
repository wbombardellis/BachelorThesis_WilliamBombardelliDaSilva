 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.arrays.impl.ArrayInitializerImpl#getInitialValues <em>Initial Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayInitializerImpl extends ArrayInitializationValueImpl implements ArrayInitializer {
	...
	public EList<ArrayInitializationValue> getInitialValues() {
		if (initialValues == null) {
			initialValues = new EObjectContainmentEList<ArrayInitializationValue>(ArrayInitializationValue.class, this, ArraysPackage.ARRAY_INITIALIZER__INITIAL_VALUES);
		}
