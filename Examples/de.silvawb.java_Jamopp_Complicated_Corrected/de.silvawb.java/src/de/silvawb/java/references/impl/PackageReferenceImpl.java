 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.references.impl.PackageReferenceImpl#getSubpackages <em>Subpackages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageReferenceImpl extends ReferenceableElementImpl implements PackageReference {
	...
	public EList<PackageReference> getSubpackages() {
		if (subpackages == null) {
			subpackages = new EObjectContainmentEList<PackageReference>(PackageReference.class, this, ReferencesPackage.PACKAGE_REFERENCE__SUBPACKAGES);
		}
		return subpackages;
	}
