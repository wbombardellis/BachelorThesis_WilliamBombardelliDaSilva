 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.references.SelfReference#getSelf <em>Self</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.references.ReferencesPackage#getSelfReference()
 * @model
 * @generated
 */
public interface SelfReference extends Reference {
	 ...
	 * @see #setSelf(Self)
	 * @see de.silvawb.java.references.ReferencesPackage#getSelfReference_Self()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.references.SelfReference#getSelf <em>Self</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
