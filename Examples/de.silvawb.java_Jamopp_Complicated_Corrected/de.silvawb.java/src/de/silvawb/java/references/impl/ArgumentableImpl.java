 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.references.impl.ArgumentableImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ArgumentableImpl extends CommentableImpl implements Argumentable {
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, ReferencesPackage.ARGUMENTABLE__ARGUMENTS);
		}
		return arguments;
	}
