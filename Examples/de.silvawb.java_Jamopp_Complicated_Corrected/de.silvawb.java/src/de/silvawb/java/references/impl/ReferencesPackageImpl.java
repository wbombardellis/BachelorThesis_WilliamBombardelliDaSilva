...
import de.silvawb.java.references.ElementReference;
import de.silvawb.java.references.IdentifierReference;
import de.silvawb.java.references.MethodCall;
import de.silvawb.java.references.PackageReference;
import de.silvawb.java.references.PrimitiveTypeReference;
...
import de.silvawb.java.references.ReflectiveClassReference;
import de.silvawb.java.references.SelfReference;
import de.silvawb.java.references.StringReference;
...
public class ReferencesPackageImpl extends EPackageImpl implements ReferencesPackage {
	 ...
	 * @see de.silvawb.java.references.ReferencesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEOperation(getReference__GetReferencedType(), theTypesPackage.getType(), "getReferencedType", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getArgumentable__GetArgumentTypes(), theTypesPackage.getType(), "getArgumentTypes", 0, -1, IS_UNIQUE, IS_ORDERED);
