 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.references.PrimitiveTypeReference#getPrimitiveType <em>Primitive Type</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.references.ReferencesPackage#getPrimitiveTypeReference()
 * @model
 * @generated
 */
public interface PrimitiveTypeReference extends Reference {
	 ...
	 * @see de.silvawb.java.references.ReferencesPackage#getPrimitiveTypeReference_PrimitiveType()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.references.PrimitiveTypeReference#getPrimitiveType <em>Primitive Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
