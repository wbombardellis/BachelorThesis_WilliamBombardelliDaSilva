 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see de.silvawb.java.variables.VariablesFactory
 * @model kind="package"
 * @generated
 */
public interface VariablesPackage extends EPackage {
	 ...
	 * @generated
	 */
	VariablesPackage eINSTANCE = de.silvawb.java.variables.impl.VariablesPackageImpl.init();

	/**
	 * The meta object id for the '{@link de.silvawb.java.variables.impl.VariableImpl <em>Variable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.silvawb.java.variables.impl.VariableImpl
	 * @see de.silvawb.java.variables.impl.VariablesPackageImpl#getVariable()
	 * @generated
	 */
	int VARIABLE = 0;
	...
	/**
	 * The meta object id for the '{@link de.silvawb.java.variables.impl.LocalVariableImpl <em>Local Variable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.silvawb.java.variables.impl.LocalVariableImpl
	 * @see de.silvawb.java.variables.impl.VariablesPackageImpl#getLocalVariable()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int LOCAL_VARIABLE_OPERATION_COUNT = VARIABLE_OPERATION_COUNT + 13;

	/**
	 * The meta object id for the '{@link de.silvawb.java.variables.impl.AdditionalLocalVariableImpl <em>Additional Local Variable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.silvawb.java.variables.impl.AdditionalLocalVariableImpl
	 * @see de.silvawb.java.variables.impl.VariablesPackageImpl#getAdditionalLocalVariable()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link de.silvawb.java.variables.Variable <em>Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the '{@link de.silvawb.java.variables.Variable#getArrayDimension() <em>Get Array Dimension</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Array Dimension</em>' operation.
	 * @see de.silvawb.java.variables.Variable#getArrayDimension()
	 * @generated
	 */
	EOperation getVariable__GetArrayDimension();

	/**
	 * Returns the meta object for the '{@link de.silvawb.java.variables.Variable#createMethodCallStatement(java.lang.String, org.eclipse.emf.common.util.EList) <em>Create Method Call Statement</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Create Method Call Statement</em>' operation.
	 * @see de.silvawb.java.variables.Variable#createMethodCallStatement(java.lang.String, org.eclipse.emf.common.util.EList)
	 * @generated
	 */
	EOperation getVariable__CreateMethodCallStatement__String_EList();

	/**
	 * Returns the meta object for the '{@link de.silvawb.java.variables.Variable#createMethodCall(java.lang.String, org.eclipse.emf.common.util.EList) <em>Create Method Call</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Create Method Call</em>' operation.
	 * @see de.silvawb.java.variables.Variable#createMethodCall(java.lang.String, org.eclipse.emf.common.util.EList)
	 * @generated
	 */
	EOperation getVariable__CreateMethodCall__String_EList();

	/**
	 * Returns the meta object for class '{@link de.silvawb.java.variables.LocalVariable <em>Local Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Local Variable</em>'.
	 * @see de.silvawb.java.variables.LocalVariable
	 * @generated
	 */
	EClass getLocalVariable();

	/**
	 * Returns the meta object for the containment reference list '{@link de.silvawb.java.variables.LocalVariable#getAdditionalLocalVariables <em>Additional Local Variables</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Additional Local Variables</em>'.
	 * @see de.silvawb.java.variables.LocalVariable#getAdditionalLocalVariables()
	...
	/**
	 * Returns the meta object for class '{@link de.silvawb.java.variables.AdditionalLocalVariable <em>Additional Local Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Additional Local Variable</em>'.
	 * @see de.silvawb.java.variables.AdditionalLocalVariable
	 * @generated
	 */
	EClass getAdditionalLocalVariable();

	/**
	 * Returns the meta object for the '{@link de.silvawb.java.variables.AdditionalLocalVariable#getArrayDimension() <em>Get Array Dimension</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Array Dimension</em>' operation.
	 * @see de.silvawb.java.variables.AdditionalLocalVariable#getArrayDimension()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.silvawb.java.variables.impl.VariableImpl <em>Variable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.silvawb.java.variables.impl.VariableImpl
		 * @see de.silvawb.java.variables.impl.VariablesPackageImpl#getVariable()
		 ...
		 * @generated
		 */
		EOperation VARIABLE___CREATE_METHOD_CALL_STATEMENT__STRING_ELIST = eINSTANCE.getVariable__CreateMethodCallStatement__String_EList();
		 ...
		 * @generated
		 */
		EOperation VARIABLE___CREATE_METHOD_CALL__STRING_ELIST = eINSTANCE.getVariable__CreateMethodCall__String_EList();

		/**
		 * The meta object literal for the '{@link de.silvawb.java.variables.impl.LocalVariableImpl <em>Local Variable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.silvawb.java.variables.impl.LocalVariableImpl
		 * @see de.silvawb.java.variables.impl.VariablesPackageImpl#getLocalVariable()
		...
		/**
		 * The meta object literal for the '{@link de.silvawb.java.variables.impl.AdditionalLocalVariableImpl <em>Additional Local Variable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.silvawb.java.variables.impl.AdditionalLocalVariableImpl
		 * @see de.silvawb.java.variables.impl.VariablesPackageImpl#getAdditionalLocalVariable()
		 ...
		 * @generated
		 */
		EOperation ADDITIONAL_LOCAL_VARIABLE___GET_ARRAY_DIMENSION = eINSTANCE.getAdditionalLocalVariable__GetArrayDimension();
