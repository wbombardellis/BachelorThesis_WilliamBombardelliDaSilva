...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>x2y Axiom r1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.x2y.generated.impl.x2yAxiom_r1Impl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class x2yAxiom_r1Impl extends OperationalAxiomImpl implements x2yAxiom_r1 {
	/**
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.X2Y_AXIOM_R1;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__ADD_ELEMENT_ACTIVITY, oldAddElementActivity,
							addElementActivity));
			}
		}
	...
	public void setAddElementActivity(Activity newAddElementActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratedPackage.X2Y_AXIOM_R1__ADD_ELEMENT_ACTIVITY,
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__MOVE_ELEMENT_ACTIVITY, oldMoveElementActivity,
							moveElementActivity));
			}
		}
	...
	public void setMoveElementActivity(Activity newMoveElementActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratedPackage.X2Y_AXIOM_R1__MOVE_ELEMENT_ACTIVITY,
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__CHANGE_ATTRIBUTE_ACTIVITY, oldChangeAttributeActivity,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__TRANSFORM_FORWARD_ACTIVITY, oldTransformForwardActivity,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__TRANSFORM_MAPPING_ACTIVITY, oldTransformMappingActivity,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__TRANSFORM_BACKWARD_ACTIVITY, oldTransformBackwardActivity,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__SYNCHRONIZE_FORWARD_ACTIVITY, oldSynchronizeForwardActivity,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.X2Y_AXIOM_R1__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public void setSynchronizeBackwardActivity(Activity newSynchronizeBackwardActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratedPackage.X2Y_AXIOM_R1__SYNCHRONIZE_BACKWARD_ACTIVITY, oldSynchronizeBackwardActivity,
	...
	public TGGNode addElement(final EMap<String, Object> parameters, final EList<EObject> leftInputElements,
		...
		((de.mdelab.mltgg.x2y.generated.x2yOperationalTGG) this.getOperationalAxiomGroup().getOperationalTGG())
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case GeneratedPackage.X2Y_AXIOM_R1___SYNCHRONIZE_BACKWARD__ELIST_ELIST_TGGNODE_BOOLEAN:
