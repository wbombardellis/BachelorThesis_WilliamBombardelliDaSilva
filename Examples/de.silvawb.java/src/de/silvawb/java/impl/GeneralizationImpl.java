...
public class GeneralizationImpl extends MinimalEObjectImpl.Container implements Generalization {
	...
	protected EClass eStaticClass() {
		return JavaPackage.Literals.GENERALIZATION;
	}
		...
		if (general != null && general.eIsProxy()) {
			...
			if (general != oldGeneral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavaPackage.GENERALIZATION__GENERAL, oldGeneral, general));
			}
		}
		return general;
	}
	...
	public void setGeneral(Classifier newGeneral) {
		...
		general = newGeneral;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.GENERALIZATION__GENERAL, oldGeneral, general));
	}
	 ...
	 * @generated
	 */
	public Classifier getGeneralizator() {
		if (eContainerFeatureID() != JavaPackage.GENERALIZATION__GENERALIZATOR) return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGeneralizator(Classifier newGeneralizator, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newGeneralizator, JavaPackage.GENERALIZATION__GENERALIZATOR, msgs);
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setGeneralizator(Classifier newGeneralizator) {
		if (newGeneralizator != eInternalContainer() || (eContainerFeatureID() != JavaPackage.GENERALIZATION__GENERALIZATOR && newGeneralizator != null)) {
			if (EcoreUtil.isAncestor(this, newGeneralizator))
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.GENERALIZATION__GENERALIZATOR, newGeneralizator, newGeneralizator));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.GENERALIZATION__GENERALIZATOR:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetGeneralizator((Classifier)otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.GENERALIZATION__GENERALIZATOR:
				return basicSetGeneralizator(null, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.GENERALIZATION__GENERAL:
