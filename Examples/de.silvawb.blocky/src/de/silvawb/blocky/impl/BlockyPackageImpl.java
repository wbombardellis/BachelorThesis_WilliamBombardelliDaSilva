...
import de.silvawb.blocky.BlockyFactory;
...
public class BlockyPackageImpl extends EPackageImpl implements BlockyPackage {
	 ...
	 * @see de.silvawb.blocky.BlockyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BlockyPackage init() {
		if (isInited) return (BlockyPackage)EPackage.Registry.INSTANCE.getEPackage(BlockyPackage.eNS_URI);

		// Obtain or create and register package
		BlockyPackageImpl theBlockyPackage = (BlockyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BlockyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BlockyPackageImpl());
