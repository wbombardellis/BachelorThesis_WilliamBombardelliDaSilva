 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.StatementListContainerImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StatementListContainerImpl extends CommentableImpl implements StatementListContainer {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getStatementListContainer();
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, JavaPackage.STATEMENT_LIST_CONTAINER__STATEMENTS);
		}
		return statements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.STATEMENT_LIST_CONTAINER__STATEMENTS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.STATEMENT_LIST_CONTAINER___GET_LOCAL_VARIABLE__STRING:
