 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.AnnotableAndModifiableImpl#getAnnotationsAndModifiers <em>Annotations And Modifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AnnotableAndModifiableImpl extends CommentableImpl implements AnnotableAndModifiable {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getAnnotableAndModifiable();
	}
	...
	public EList<AnnotationInstanceOrModifier> getAnnotationsAndModifiers() {
		if (annotationsAndModifiers == null) {
			annotationsAndModifiers = new EObjectContainmentEList<AnnotationInstanceOrModifier>(AnnotationInstanceOrModifier.class, this, JavaPackage.ANNOTABLE_AND_MODIFIABLE__ANNOTATIONS_AND_MODIFIERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE__ANNOTATIONS_AND_MODIFIERS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_HIDDEN__COMMENTABLE:
				return isHidden((Commentable)arguments.get(0));
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_STATIC:
				return isStatic();
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___REMOVE_MODIFIER__CLASS:
				removeModifier((Class<?>)arguments.get(0));
				return null;
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___MAKE_PUBLIC:
				makePublic();
				return null;
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___MAKE_PRIVATE:
				makePrivate();
				return null;
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___MAKE_PROTECTED:
				makeProtected();
				return null;
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___GET_MODIFIERS:
				return getModifiers();
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___REMOVE_ALL_MODIFIERS:
				removeAllModifiers();
				return null;
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___HAS_MODIFIER__CLASS:
				return hasModifier((Class<?>)arguments.get(0));
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_PUBLIC:
				return isPublic();
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_PRIVATE:
				return isPrivate();
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_PROTECTED:
				return isProtected();
			case JavaPackage.ANNOTABLE_AND_MODIFIABLE___ADD_MODIFIER__MODIFIER:
