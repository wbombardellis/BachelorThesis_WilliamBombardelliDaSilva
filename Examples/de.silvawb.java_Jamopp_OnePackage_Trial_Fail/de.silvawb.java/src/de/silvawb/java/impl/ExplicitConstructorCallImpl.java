 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ExplicitConstructorCallImpl#getCallTarget <em>Call Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplicitConstructorCallImpl extends InstantiationImpl implements ExplicitConstructorCall {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getExplicitConstructorCall();
	}
	...
	public NotificationChain basicSetCallTarget(Self newCallTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.EXPLICIT_CONSTRUCTOR_CALL__CALL_TARGET, oldCallTarget, newCallTarget);
	...
	public void setCallTarget(Self newCallTarget) {
		if (newCallTarget != callTarget) {
			...
			if (callTarget != null)
				msgs = ((InternalEObject)callTarget).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.EXPLICIT_CONSTRUCTOR_CALL__CALL_TARGET, null, msgs);
			if (newCallTarget != null)
				msgs = ((InternalEObject)newCallTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.EXPLICIT_CONSTRUCTOR_CALL__CALL_TARGET, null, msgs);
			msgs = basicSetCallTarget(newCallTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.EXPLICIT_CONSTRUCTOR_CALL__CALL_TARGET, newCallTarget, newCallTarget));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.EXPLICIT_CONSTRUCTOR_CALL__CALL_TARGET:
