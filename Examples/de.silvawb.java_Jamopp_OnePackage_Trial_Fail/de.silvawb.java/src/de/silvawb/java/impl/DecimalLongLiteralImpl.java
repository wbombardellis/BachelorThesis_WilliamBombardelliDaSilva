 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.DecimalLongLiteralImpl#getDecimalValue <em>Decimal Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalLongLiteralImpl extends LongLiteralImpl implements DecimalLongLiteral {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getDecimalLongLiteral();
	}
	...
	public void setDecimalValue(BigInteger newDecimalValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.DECIMAL_LONG_LITERAL__DECIMAL_VALUE, oldDecimalValue, decimalValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.DECIMAL_LONG_LITERAL__DECIMAL_VALUE:
