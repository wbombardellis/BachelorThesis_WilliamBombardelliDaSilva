 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ExtendsTypeArgumentImpl#getExtendTypes <em>Extend Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtendsTypeArgumentImpl extends TypeArgumentImpl implements ExtendsTypeArgument {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getExtendsTypeArgument();
	}
	...
	public EList<TypeReference> getExtendTypes() {
		if (extendTypes == null) {
			extendTypes = new EObjectContainmentEList<TypeReference>(TypeReference.class, this, JavaPackage.EXTENDS_TYPE_ARGUMENT__EXTEND_TYPES);
		}
		return extendTypes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.EXTENDS_TYPE_ARGUMENT__EXTEND_TYPES:
