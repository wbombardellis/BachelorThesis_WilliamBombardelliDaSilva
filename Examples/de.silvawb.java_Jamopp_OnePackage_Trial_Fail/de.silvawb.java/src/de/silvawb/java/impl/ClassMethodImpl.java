 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ClassMethodImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassMethodImpl extends MethodImpl implements ClassMethod {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getClassMethod();
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, JavaPackage.CLASS_METHOD__STATEMENTS);
		}
		return statements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.CLASS_METHOD__STATEMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (derivedFeatureID) {
				case JavaPackage.CLASS_METHOD__STATEMENTS: return JavaPackage.STATEMENT_LIST_CONTAINER__STATEMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (baseFeatureID) {
				case JavaPackage.STATEMENT_LIST_CONTAINER__STATEMENTS: return JavaPackage.CLASS_METHOD__STATEMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (baseOperationID) {
				case JavaPackage.STATEMENT_LIST_CONTAINER___GET_LOCAL_VARIABLE__STRING: return JavaPackage.CLASS_METHOD___GET_LOCAL_VARIABLE__STRING;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.CLASS_METHOD___GET_LOCAL_VARIABLE__STRING:
