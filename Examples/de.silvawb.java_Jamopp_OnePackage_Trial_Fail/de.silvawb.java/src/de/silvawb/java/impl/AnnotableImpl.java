 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.AnnotableImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AnnotableImpl extends CommentableImpl implements Annotable {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getAnnotable();
	}
	...
	public EList<AnnotationInstance> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<AnnotationInstance>(AnnotationInstance.class, this, JavaPackage.ANNOTABLE__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.ANNOTABLE__ANNOTATIONS:
