 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.CharacterLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacterLiteralImpl extends LiteralImpl implements CharacterLiteral {
	...
	public void setValue(char newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.CHARACTER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.CHARACTER_LITERAL__VALUE:
				return getValue();
		}
