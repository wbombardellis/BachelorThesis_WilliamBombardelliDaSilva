 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.TypeArgumentableImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TypeArgumentableImpl extends CommentableImpl implements TypeArgumentable {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getTypeArgumentable();
	}
	...
	public EList<TypeArgument> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectContainmentEList<TypeArgument>(TypeArgument.class, this, JavaPackage.TYPE_ARGUMENTABLE__TYPE_ARGUMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.TYPE_ARGUMENTABLE__TYPE_ARGUMENTS:
