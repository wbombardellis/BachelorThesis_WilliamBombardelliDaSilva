 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.AnnotationInstanceImpl#getNamespaces <em>Namespaces</em>}</li>
 *   <li>{@link de.silvawb.java.impl.AnnotationInstanceImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link de.silvawb.java.impl.AnnotationInstanceImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationInstanceImpl extends ReferenceImpl implements AnnotationInstance {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getAnnotationInstance();
	}
	...
	public EList<String> getNamespaces() {
		if (namespaces == null) {
			namespaces = new EDataTypeEList<String>(String.class, this, JavaPackage.ANNOTATION_INSTANCE__NAMESPACES);
		}
		return namespaces;
	}
	...
	public NotificationChain basicSetParameter(AnnotationParameter newParameter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.ANNOTATION_INSTANCE__PARAMETER, oldParameter, newParameter);
	...
	public void setParameter(AnnotationParameter newParameter) {
		if (newParameter != parameter) {
			...
			if (parameter != null)
				msgs = ((InternalEObject)parameter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ANNOTATION_INSTANCE__PARAMETER, null, msgs);
			if (newParameter != null)
				msgs = ((InternalEObject)newParameter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ANNOTATION_INSTANCE__PARAMETER, null, msgs);
			msgs = basicSetParameter(newParameter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.ANNOTATION_INSTANCE__PARAMETER, newParameter, newParameter));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.ANNOTATION_INSTANCE__PARAMETER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.ANNOTATION_INSTANCE__NAMESPACES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NamespaceAwareElement.class) {
			switch (derivedFeatureID) {
				case JavaPackage.ANNOTATION_INSTANCE__NAMESPACES: return JavaPackage.NAMESPACE_AWARE_ELEMENT__NAMESPACES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NamespaceAwareElement.class) {
			switch (baseFeatureID) {
				case JavaPackage.NAMESPACE_AWARE_ELEMENT__NAMESPACES: return JavaPackage.ANNOTATION_INSTANCE__NAMESPACES;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == NamespaceAwareElement.class) {
			switch (baseOperationID) {
				case JavaPackage.NAMESPACE_AWARE_ELEMENT___GET_NAMESPACES_AS_STRING: return JavaPackage.ANNOTATION_INSTANCE___GET_NAMESPACES_AS_STRING;
				case JavaPackage.NAMESPACE_AWARE_ELEMENT___GET_CLASSIFIER_AT_NAMESPACES: return JavaPackage.ANNOTATION_INSTANCE___GET_CLASSIFIER_AT_NAMESPACES;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.ANNOTATION_INSTANCE___GET_NAMESPACES_AS_STRING:
				return getNamespacesAsString();
			case JavaPackage.ANNOTATION_INSTANCE___GET_CLASSIFIER_AT_NAMESPACES:
