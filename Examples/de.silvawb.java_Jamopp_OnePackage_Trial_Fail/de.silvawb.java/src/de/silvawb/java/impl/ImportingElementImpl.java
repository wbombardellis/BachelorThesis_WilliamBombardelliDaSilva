 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ImportingElementImpl#getImports <em>Imports</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ImportingElementImpl extends CommentableImpl implements ImportingElement {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getImportingElement();
	}
	...
	public EList<Import> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<Import>(Import.class, this, JavaPackage.IMPORTING_ELEMENT__IMPORTS);
		}
		return imports;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.IMPORTING_ELEMENT__IMPORTS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.IMPORTING_ELEMENT___GET_DEFAULT_IMPORTS:
