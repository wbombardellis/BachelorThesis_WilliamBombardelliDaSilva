 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ArrayTypeableImpl#getArrayDimensionsBefore <em>Array Dimensions Before</em>}</li>
 *   <li>{@link de.silvawb.java.impl.ArrayTypeableImpl#getArrayDimensionsAfter <em>Array Dimensions After</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ArrayTypeableImpl extends CommentableImpl implements ArrayTypeable {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getArrayTypeable();
	}
	...
	public EList<ArrayDimension> getArrayDimensionsBefore() {
		if (arrayDimensionsBefore == null) {
			arrayDimensionsBefore = new EObjectContainmentEList<ArrayDimension>(ArrayDimension.class, this, JavaPackage.ARRAY_TYPEABLE__ARRAY_DIMENSIONS_BEFORE);
		}
	...
	public EList<ArrayDimension> getArrayDimensionsAfter() {
		if (arrayDimensionsAfter == null) {
			arrayDimensionsAfter = new EObjectContainmentEList<ArrayDimension>(ArrayDimension.class, this, JavaPackage.ARRAY_TYPEABLE__ARRAY_DIMENSIONS_AFTER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.ARRAY_TYPEABLE__ARRAY_DIMENSIONS_BEFORE:
				return ((InternalEList<?>)getArrayDimensionsBefore()).basicRemove(otherEnd, msgs);
			case JavaPackage.ARRAY_TYPEABLE__ARRAY_DIMENSIONS_AFTER:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.ARRAY_TYPEABLE___GET_ARRAY_DIMENSION:
