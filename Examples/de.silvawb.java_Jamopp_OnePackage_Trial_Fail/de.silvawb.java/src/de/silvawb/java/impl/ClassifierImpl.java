...
public abstract class ClassifierImpl extends TypeImpl implements Classifier {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getClassifier();
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case JavaPackage.CLASSIFIER__NAME: return JavaPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case JavaPackage.NAMED_ELEMENT__NAME: return JavaPackage.CLASSIFIER__NAME;
				default: return -1;
			}
		}
		if (baseClass == ReferenceableElement.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.CLASSIFIER___GET_ALL_SUPER_CLASSIFIERS:
