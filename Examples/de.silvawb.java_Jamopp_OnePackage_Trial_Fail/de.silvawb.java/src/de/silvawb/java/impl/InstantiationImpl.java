 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.InstantiationImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InstantiationImpl extends ReferenceImpl implements Instantiation {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getInstantiation();
	}
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, JavaPackage.INSTANTIATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.INSTANTIATION__ARGUMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Argumentable.class) {
			switch (derivedFeatureID) {
				case JavaPackage.INSTANTIATION__ARGUMENTS: return JavaPackage.ARGUMENTABLE__ARGUMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Argumentable.class) {
			switch (baseFeatureID) {
				case JavaPackage.ARGUMENTABLE__ARGUMENTS: return JavaPackage.INSTANTIATION__ARGUMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Argumentable.class) {
			switch (baseOperationID) {
				case JavaPackage.ARGUMENTABLE___GET_ARGUMENT_TYPES: return JavaPackage.INSTANTIATION___GET_ARGUMENT_TYPES;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.INSTANTIATION___GET_ARGUMENT_TYPES:
