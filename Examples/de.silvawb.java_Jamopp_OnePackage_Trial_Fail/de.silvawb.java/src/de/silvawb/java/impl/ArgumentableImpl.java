 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ArgumentableImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ArgumentableImpl extends CommentableImpl implements Argumentable {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getArgumentable();
	}
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, JavaPackage.ARGUMENTABLE__ARGUMENTS);
		}
		return arguments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.ARGUMENTABLE__ARGUMENTS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.ARGUMENTABLE___GET_ARGUMENT_TYPES:
