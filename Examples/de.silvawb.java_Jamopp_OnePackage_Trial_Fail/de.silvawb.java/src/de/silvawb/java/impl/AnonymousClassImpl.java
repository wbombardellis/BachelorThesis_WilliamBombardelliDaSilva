 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.AnonymousClassImpl#getMembers <em>Members</em>}</li>
 *   <li>{@link de.silvawb.java.impl.AnonymousClassImpl#getDefaultMembers <em>Default Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnonymousClassImpl extends TypeImpl implements AnonymousClass {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getAnonymousClass();
	}
	...
	public EList<Member> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<Member>(Member.class, this, JavaPackage.ANONYMOUS_CLASS__MEMBERS);
		}
		return members;
	}
	...
	public EList<Member> getDefaultMembers() {
		if (defaultMembers == null) {
			defaultMembers = new EObjectContainmentEList<Member>(Member.class, this, JavaPackage.ANONYMOUS_CLASS__DEFAULT_MEMBERS);
		}
	...
	public EList<ConcreteClassifier> getAllSuperClassifiers() {
		org.eclipse.emf.common.util.EList< de.silvawb.java.ConcreteClassifier> superClassifierList = new org.emftext.language.java.util.UniqueEList< de.silvawb.java.ConcreteClassifier>();
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.ANONYMOUS_CLASS__MEMBERS:
				return ((InternalEList<?>)getMembers()).basicRemove(otherEnd, msgs);
			case JavaPackage.ANONYMOUS_CLASS__DEFAULT_MEMBERS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MemberContainer.class) {
			switch (derivedFeatureID) {
				case JavaPackage.ANONYMOUS_CLASS__MEMBERS: return JavaPackage.MEMBER_CONTAINER__MEMBERS;
				case JavaPackage.ANONYMOUS_CLASS__DEFAULT_MEMBERS: return JavaPackage.MEMBER_CONTAINER__DEFAULT_MEMBERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MemberContainer.class) {
			switch (baseFeatureID) {
				case JavaPackage.MEMBER_CONTAINER__MEMBERS: return JavaPackage.ANONYMOUS_CLASS__MEMBERS;
				case JavaPackage.MEMBER_CONTAINER__DEFAULT_MEMBERS: return JavaPackage.ANONYMOUS_CLASS__DEFAULT_MEMBERS;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseOperationID) {
				case JavaPackage.TYPE___GET_ALL_MEMBERS__COMMENTABLE: return JavaPackage.ANONYMOUS_CLASS___GET_ALL_MEMBERS__COMMENTABLE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == MemberContainer.class) {
			switch (baseOperationID) {
				case JavaPackage.MEMBER_CONTAINER___GET_CONTAINED_CLASSIFIER__STRING: return JavaPackage.ANONYMOUS_CLASS___GET_CONTAINED_CLASSIFIER__STRING;
				case JavaPackage.MEMBER_CONTAINER___GET_CONTAINED_FIELD__STRING: return JavaPackage.ANONYMOUS_CLASS___GET_CONTAINED_FIELD__STRING;
				case JavaPackage.MEMBER_CONTAINER___GET_CONTAINED_METHOD__STRING: return JavaPackage.ANONYMOUS_CLASS___GET_CONTAINED_METHOD__STRING;
				case JavaPackage.MEMBER_CONTAINER___GET_METHODS: return JavaPackage.ANONYMOUS_CLASS___GET_METHODS;
				case JavaPackage.MEMBER_CONTAINER___REMOVE_METHODS__STRING: return JavaPackage.ANONYMOUS_CLASS___REMOVE_METHODS__STRING;
				case JavaPackage.MEMBER_CONTAINER___GET_MEMBERS_BY_NAME__STRING: return JavaPackage.ANONYMOUS_CLASS___GET_MEMBERS_BY_NAME__STRING;
				case JavaPackage.MEMBER_CONTAINER___CREATE_FIELD__STRING_STRING: return JavaPackage.ANONYMOUS_CLASS___CREATE_FIELD__STRING_STRING;
				case JavaPackage.MEMBER_CONTAINER___GET_FIELDS: return JavaPackage.ANONYMOUS_CLASS___GET_FIELDS;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.ANONYMOUS_CLASS___GET_ALL_SUPER_CLASSIFIERS:
				return getAllSuperClassifiers();
			case JavaPackage.ANONYMOUS_CLASS___GET_SUPER_CLASSIFIER:
				return getSuperClassifier();
			case JavaPackage.ANONYMOUS_CLASS___GET_ALL_MEMBERS__COMMENTABLE:
				return getAllMembers((Commentable)arguments.get(0));
			case JavaPackage.ANONYMOUS_CLASS___GET_CONTAINED_CLASSIFIER__STRING:
				return getContainedClassifier((String)arguments.get(0));
			case JavaPackage.ANONYMOUS_CLASS___GET_CONTAINED_FIELD__STRING:
				return getContainedField((String)arguments.get(0));
			case JavaPackage.ANONYMOUS_CLASS___GET_CONTAINED_METHOD__STRING:
				return getContainedMethod((String)arguments.get(0));
			case JavaPackage.ANONYMOUS_CLASS___GET_METHODS:
				return getMethods();
			case JavaPackage.ANONYMOUS_CLASS___REMOVE_METHODS__STRING:
				removeMethods((String)arguments.get(0));
				return null;
			case JavaPackage.ANONYMOUS_CLASS___GET_MEMBERS_BY_NAME__STRING:
				return getMembersByName((String)arguments.get(0));
			case JavaPackage.ANONYMOUS_CLASS___CREATE_FIELD__STRING_STRING:
				return createField((String)arguments.get(0), (String)arguments.get(1));
			case JavaPackage.ANONYMOUS_CLASS___GET_FIELDS:
				return getFields();
		}
