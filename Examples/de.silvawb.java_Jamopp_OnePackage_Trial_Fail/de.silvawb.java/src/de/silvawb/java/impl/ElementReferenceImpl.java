 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ElementReferenceImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ElementReferenceImpl extends ReferenceImpl implements ElementReference {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getElementReference();
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavaPackage.ELEMENT_REFERENCE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ReferenceableElement newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.ELEMENT_REFERENCE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.ELEMENT_REFERENCE__TARGET:
