 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.NamespaceAwareElementImpl#getNamespaces <em>Namespaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamespaceAwareElementImpl extends CommentableImpl implements NamespaceAwareElement {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getNamespaceAwareElement();
	}
	...
	public EList<String> getNamespaces() {
		if (namespaces == null) {
			namespaces = new EDataTypeEList<String>(String.class, this, JavaPackage.NAMESPACE_AWARE_ELEMENT__NAMESPACES);
		}
		return namespaces;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.NAMESPACE_AWARE_ELEMENT__NAMESPACES:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.NAMESPACE_AWARE_ELEMENT___GET_NAMESPACES_AS_STRING:
				return getNamespacesAsString();
			case JavaPackage.NAMESPACE_AWARE_ELEMENT___GET_CLASSIFIER_AT_NAMESPACES:
