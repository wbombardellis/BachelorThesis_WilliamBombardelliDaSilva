 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ImplementorImpl#getImplements <em>Implements</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ImplementorImpl extends CommentableImpl implements Implementor {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getImplementor();
	}
	...
	public EList<TypeReference> getImplements() {
		if (implements_ == null) {
			implements_ = new EObjectContainmentEList<TypeReference>(TypeReference.class, this, JavaPackage.IMPLEMENTOR__IMPLEMENTS);
		}
		return implements_;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.IMPLEMENTOR__IMPLEMENTS:
