 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ModifiableImpl#getModifiers <em>Modifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModifiableImpl extends CommentableImpl implements Modifiable {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getModifiable();
	}
	...
	public EList<Modifier> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectContainmentEList<Modifier>(Modifier.class, this, JavaPackage.MODIFIABLE__MODIFIERS);
		}
		return modifiers;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.MODIFIABLE__MODIFIERS:
