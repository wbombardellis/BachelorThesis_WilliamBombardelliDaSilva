 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.AndExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndExpressionImpl extends ExclusiveOrExpressionChildImpl implements AndExpression {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getAndExpression();
	}
	...
	public EList<AndExpressionChild> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<AndExpressionChild>(AndExpressionChild.class, this, JavaPackage.AND_EXPRESSION__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.AND_EXPRESSION__CHILDREN:
