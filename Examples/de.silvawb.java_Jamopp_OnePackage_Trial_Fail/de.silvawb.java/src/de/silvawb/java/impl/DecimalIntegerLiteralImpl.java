 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.DecimalIntegerLiteralImpl#getDecimalValue <em>Decimal Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalIntegerLiteralImpl extends IntegerLiteralImpl implements DecimalIntegerLiteral {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getDecimalIntegerLiteral();
	}
	...
	public void setDecimalValue(BigInteger newDecimalValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.DECIMAL_INTEGER_LITERAL__DECIMAL_VALUE, oldDecimalValue, decimalValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.DECIMAL_INTEGER_LITERAL__DECIMAL_VALUE:
