 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.OctalLongLiteralImpl#getOctalValue <em>Octal Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OctalLongLiteralImpl extends LongLiteralImpl implements OctalLongLiteral {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getOctalLongLiteral();
	}
	...
	public void setOctalValue(BigInteger newOctalValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.OCTAL_LONG_LITERAL__OCTAL_VALUE, oldOctalValue, octalValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.OCTAL_LONG_LITERAL__OCTAL_VALUE:
