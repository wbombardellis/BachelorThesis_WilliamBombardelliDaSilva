 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ConstructorImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link de.silvawb.java.impl.ConstructorImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link de.silvawb.java.impl.ConstructorImpl#getTypeParameters <em>Type Parameters</em>}</li>
 *   <li>{@link de.silvawb.java.impl.ConstructorImpl#getExceptions <em>Exceptions</em>}</li>
 *   <li>{@link de.silvawb.java.impl.ConstructorImpl#getAnnotationsAndModifiers <em>Annotations And Modifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstructorImpl extends MemberImpl implements Constructor {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getConstructor();
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, JavaPackage.CONSTRUCTOR__STATEMENTS);
		}
		return statements;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, JavaPackage.CONSTRUCTOR__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<TypeParameter> getTypeParameters() {
		if (typeParameters == null) {
			typeParameters = new EObjectContainmentEList<TypeParameter>(TypeParameter.class, this, JavaPackage.CONSTRUCTOR__TYPE_PARAMETERS);
		}
	...
	public EList<NamespaceClassifierReference> getExceptions() {
		if (exceptions == null) {
			exceptions = new EObjectContainmentEList<NamespaceClassifierReference>(NamespaceClassifierReference.class, this, JavaPackage.CONSTRUCTOR__EXCEPTIONS);
		}
		return exceptions;
	}
	...
	public EList<AnnotationInstanceOrModifier> getAnnotationsAndModifiers() {
		if (annotationsAndModifiers == null) {
			annotationsAndModifiers = new EObjectContainmentEList<AnnotationInstanceOrModifier>(AnnotationInstanceOrModifier.class, this, JavaPackage.CONSTRUCTOR__ANNOTATIONS_AND_MODIFIERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.CONSTRUCTOR__STATEMENTS:
				return ((InternalEList<?>)getStatements()).basicRemove(otherEnd, msgs);
			case JavaPackage.CONSTRUCTOR__PARAMETERS:
				return ((InternalEList<?>)getParameters()).basicRemove(otherEnd, msgs);
			case JavaPackage.CONSTRUCTOR__TYPE_PARAMETERS:
				return ((InternalEList<?>)getTypeParameters()).basicRemove(otherEnd, msgs);
			case JavaPackage.CONSTRUCTOR__EXCEPTIONS:
				return ((InternalEList<?>)getExceptions()).basicRemove(otherEnd, msgs);
			case JavaPackage.CONSTRUCTOR__ANNOTATIONS_AND_MODIFIERS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (derivedFeatureID) {
				case JavaPackage.CONSTRUCTOR__STATEMENTS: return JavaPackage.STATEMENT_LIST_CONTAINER__STATEMENTS;
				default: return -1;
			}
		}
		if (baseClass == Parametrizable.class) {
			switch (derivedFeatureID) {
				case JavaPackage.CONSTRUCTOR__PARAMETERS: return JavaPackage.PARAMETRIZABLE__PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == TypeParametrizable.class) {
			switch (derivedFeatureID) {
				case JavaPackage.CONSTRUCTOR__TYPE_PARAMETERS: return JavaPackage.TYPE_PARAMETRIZABLE__TYPE_PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == ExceptionThrower.class) {
			switch (derivedFeatureID) {
				case JavaPackage.CONSTRUCTOR__EXCEPTIONS: return JavaPackage.EXCEPTION_THROWER__EXCEPTIONS;
				default: return -1;
			}
		}
		if (baseClass == AnnotableAndModifiable.class) {
			switch (derivedFeatureID) {
				case JavaPackage.CONSTRUCTOR__ANNOTATIONS_AND_MODIFIERS: return JavaPackage.ANNOTABLE_AND_MODIFIABLE__ANNOTATIONS_AND_MODIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (baseFeatureID) {
				case JavaPackage.STATEMENT_LIST_CONTAINER__STATEMENTS: return JavaPackage.CONSTRUCTOR__STATEMENTS;
				default: return -1;
			}
		}
		if (baseClass == Parametrizable.class) {
			switch (baseFeatureID) {
				case JavaPackage.PARAMETRIZABLE__PARAMETERS: return JavaPackage.CONSTRUCTOR__PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == TypeParametrizable.class) {
			switch (baseFeatureID) {
				case JavaPackage.TYPE_PARAMETRIZABLE__TYPE_PARAMETERS: return JavaPackage.CONSTRUCTOR__TYPE_PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == ExceptionThrower.class) {
			switch (baseFeatureID) {
				case JavaPackage.EXCEPTION_THROWER__EXCEPTIONS: return JavaPackage.CONSTRUCTOR__EXCEPTIONS;
				default: return -1;
			}
		}
		if (baseClass == AnnotableAndModifiable.class) {
			switch (baseFeatureID) {
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE__ANNOTATIONS_AND_MODIFIERS: return JavaPackage.CONSTRUCTOR__ANNOTATIONS_AND_MODIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == StatementListContainer.class) {
			switch (baseOperationID) {
				case JavaPackage.STATEMENT_LIST_CONTAINER___GET_LOCAL_VARIABLE__STRING: return JavaPackage.CONSTRUCTOR___GET_LOCAL_VARIABLE__STRING;
				default: return -1;
			}
		}
		if (baseClass == Parametrizable.class) {
		...
		if (baseClass == AnnotableAndModifiable.class) {
			switch (baseOperationID) {
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_HIDDEN__COMMENTABLE: return JavaPackage.CONSTRUCTOR___IS_HIDDEN__COMMENTABLE;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_STATIC: return JavaPackage.CONSTRUCTOR___IS_STATIC;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___REMOVE_MODIFIER__CLASS: return JavaPackage.CONSTRUCTOR___REMOVE_MODIFIER__CLASS;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___MAKE_PUBLIC: return JavaPackage.CONSTRUCTOR___MAKE_PUBLIC;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___MAKE_PRIVATE: return JavaPackage.CONSTRUCTOR___MAKE_PRIVATE;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___MAKE_PROTECTED: return JavaPackage.CONSTRUCTOR___MAKE_PROTECTED;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___GET_MODIFIERS: return JavaPackage.CONSTRUCTOR___GET_MODIFIERS;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___REMOVE_ALL_MODIFIERS: return JavaPackage.CONSTRUCTOR___REMOVE_ALL_MODIFIERS;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___HAS_MODIFIER__CLASS: return JavaPackage.CONSTRUCTOR___HAS_MODIFIER__CLASS;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_PUBLIC: return JavaPackage.CONSTRUCTOR___IS_PUBLIC;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_PRIVATE: return JavaPackage.CONSTRUCTOR___IS_PRIVATE;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___IS_PROTECTED: return JavaPackage.CONSTRUCTOR___IS_PROTECTED;
				case JavaPackage.ANNOTABLE_AND_MODIFIABLE___ADD_MODIFIER__MODIFIER: return JavaPackage.CONSTRUCTOR___ADD_MODIFIER__MODIFIER;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JavaPackage.CONSTRUCTOR___IS_HIDDEN__COMMENTABLE:
				return isHidden((Commentable)arguments.get(0));
			case JavaPackage.CONSTRUCTOR___IS_STATIC:
				return isStatic();
			case JavaPackage.CONSTRUCTOR___REMOVE_MODIFIER__CLASS:
				removeModifier((Class<?>)arguments.get(0));
				return null;
			case JavaPackage.CONSTRUCTOR___MAKE_PUBLIC:
				makePublic();
				return null;
			case JavaPackage.CONSTRUCTOR___MAKE_PRIVATE:
				makePrivate();
				return null;
			case JavaPackage.CONSTRUCTOR___MAKE_PROTECTED:
				makeProtected();
				return null;
			case JavaPackage.CONSTRUCTOR___GET_MODIFIERS:
				return getModifiers();
			case JavaPackage.CONSTRUCTOR___REMOVE_ALL_MODIFIERS:
				removeAllModifiers();
				return null;
			case JavaPackage.CONSTRUCTOR___HAS_MODIFIER__CLASS:
				return hasModifier((Class<?>)arguments.get(0));
			case JavaPackage.CONSTRUCTOR___IS_PUBLIC:
				return isPublic();
			case JavaPackage.CONSTRUCTOR___IS_PRIVATE:
				return isPrivate();
			case JavaPackage.CONSTRUCTOR___IS_PROTECTED:
				return isProtected();
			case JavaPackage.CONSTRUCTOR___ADD_MODIFIER__MODIFIER:
				addModifier((Modifier)arguments.get(0));
				return null;
			case JavaPackage.CONSTRUCTOR___GET_LOCAL_VARIABLE__STRING:
