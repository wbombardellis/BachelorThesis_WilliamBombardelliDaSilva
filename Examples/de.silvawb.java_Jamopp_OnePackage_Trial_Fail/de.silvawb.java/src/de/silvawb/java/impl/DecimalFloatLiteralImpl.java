 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.DecimalFloatLiteralImpl#getDecimalValue <em>Decimal Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalFloatLiteralImpl extends FloatLiteralImpl implements DecimalFloatLiteral {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getDecimalFloatLiteral();
	}
	...
	public void setDecimalValue(float newDecimalValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.DECIMAL_FLOAT_LITERAL__DECIMAL_VALUE, oldDecimalValue, decimalValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.DECIMAL_FLOAT_LITERAL__DECIMAL_VALUE:
