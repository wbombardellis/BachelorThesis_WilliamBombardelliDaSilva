 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.DecimalDoubleLiteralImpl#getDecimalValue <em>Decimal Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalDoubleLiteralImpl extends DoubleLiteralImpl implements DecimalDoubleLiteral {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getDecimalDoubleLiteral();
	}
	...
	public void setDecimalValue(double newDecimalValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.DECIMAL_DOUBLE_LITERAL__DECIMAL_VALUE, oldDecimalValue, decimalValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.DECIMAL_DOUBLE_LITERAL__DECIMAL_VALUE:
