 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.HexLongLiteralImpl#getHexValue <em>Hex Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HexLongLiteralImpl extends LongLiteralImpl implements HexLongLiteral {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getHexLongLiteral();
	}
	...
	public void setHexValue(BigInteger newHexValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.HEX_LONG_LITERAL__HEX_VALUE, oldHexValue, hexValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JavaPackage.HEX_LONG_LITERAL__HEX_VALUE:
				return getHexValue();
		}
