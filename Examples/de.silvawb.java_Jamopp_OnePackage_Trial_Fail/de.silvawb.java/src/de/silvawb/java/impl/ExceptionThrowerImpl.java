 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.ExceptionThrowerImpl#getExceptions <em>Exceptions</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ExceptionThrowerImpl extends CommentableImpl implements ExceptionThrower {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getExceptionThrower();
	}
	...
	public EList<NamespaceClassifierReference> getExceptions() {
		if (exceptions == null) {
			exceptions = new EObjectContainmentEList<NamespaceClassifierReference>(NamespaceClassifierReference.class, this, JavaPackage.EXCEPTION_THROWER__EXCEPTIONS);
		}
		return exceptions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.EXCEPTION_THROWER__EXCEPTIONS:
