 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.impl.CallTypeArgumentableImpl#getCallTypeArguments <em>Call Type Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CallTypeArgumentableImpl extends CommentableImpl implements CallTypeArgumentable {
	...
	protected EClass eStaticClass() {
		return JavaPackage.eINSTANCE.getCallTypeArgumentable();
	}
	...
	public EList<TypeArgument> getCallTypeArguments() {
		if (callTypeArguments == null) {
			callTypeArguments = new EObjectContainmentEList<TypeArgument>(TypeArgument.class, this, JavaPackage.CALL_TYPE_ARGUMENTABLE__CALL_TYPE_ARGUMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.CALL_TYPE_ARGUMENTABLE__CALL_TYPE_ARGUMENTS:
