 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.CastExpression#getChild <em>Child</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getCastExpression()
 * @model
 * @generated
 */
public interface CastExpression extends TypedElement, ArrayTypeable, UnaryModificationExpressionChild {
	 ...
	 * @see de.silvawb.java.JavaPackage#getCastExpression_Child()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.CastExpression#getChild <em>Child</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
