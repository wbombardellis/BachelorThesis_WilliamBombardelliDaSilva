 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.Condition#getElseStatement <em>Else Statement</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getCondition()
 * @model
 * @generated
 */
public interface Condition extends Statement, StatementContainer, Conditional {
	 ...
	 * @see de.silvawb.java.JavaPackage#getCondition_ElseStatement()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.Condition#getElseStatement <em>Else Statement</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
