 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.ExplicitConstructorCall#getCallTarget <em>Call Target</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getExplicitConstructorCall()
 * @model
 * @generated
 */
public interface ExplicitConstructorCall extends Instantiation {
	 ...
	 * @see de.silvawb.java.JavaPackage#getExplicitConstructorCall_CallTarget()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.ExplicitConstructorCall#getCallTarget <em>Call Target</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
