 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.HexIntegerLiteral#getHexValue <em>Hex Value</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getHexIntegerLiteral()
 * @model
 * @generated
 */
public interface HexIntegerLiteral extends IntegerLiteral {
	 ...
	 * @see de.silvawb.java.JavaPackage#getHexIntegerLiteral_HexValue()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.HexIntegerLiteral#getHexValue <em>Hex Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
