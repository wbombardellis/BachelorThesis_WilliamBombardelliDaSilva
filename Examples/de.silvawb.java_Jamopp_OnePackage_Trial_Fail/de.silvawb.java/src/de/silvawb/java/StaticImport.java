 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.StaticImport#getStatic <em>Static</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getStaticImport()
 * @model abstract="true"
 * @generated
 */
public interface StaticImport extends Import {
	 ...
	 * @see de.silvawb.java.JavaPackage#getStaticImport_Static()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.StaticImport#getStatic <em>Static</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
