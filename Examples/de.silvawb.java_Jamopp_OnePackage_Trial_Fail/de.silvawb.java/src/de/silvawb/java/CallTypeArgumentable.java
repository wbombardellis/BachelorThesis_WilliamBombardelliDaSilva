 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.CallTypeArgumentable#getCallTypeArguments <em>Call Type Arguments</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getCallTypeArgumentable()
 * @model abstract="true"
 * @generated
 */
public interface CallTypeArgumentable extends Commentable {
	 ...
	 * @see de.silvawb.java.JavaPackage#getCallTypeArgumentable_CallTypeArguments()
