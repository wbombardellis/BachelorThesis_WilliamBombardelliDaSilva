 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.Assert#getErrorMessage <em>Error Message</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getAssert()
 * @model
 * @generated
 */
public interface Assert extends Statement, Conditional {
	 ...
	 * @see de.silvawb.java.JavaPackage#getAssert_ErrorMessage()
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.Assert#getErrorMessage <em>Error Message</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
