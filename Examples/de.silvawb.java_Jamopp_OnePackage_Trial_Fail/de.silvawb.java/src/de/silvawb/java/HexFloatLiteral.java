 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.HexFloatLiteral#getHexValue <em>Hex Value</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getHexFloatLiteral()
 * @model
 * @generated
 */
public interface HexFloatLiteral extends FloatLiteral {
	 ...
	 * @see de.silvawb.java.JavaPackage#getHexFloatLiteral_HexValue()
	 * @model required="true"
	 * @generated
	 */
	float getHexValue();
	...
	/**
	 * Sets the value of the '{@link de.silvawb.java.HexFloatLiteral#getHexValue <em>Hex Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
