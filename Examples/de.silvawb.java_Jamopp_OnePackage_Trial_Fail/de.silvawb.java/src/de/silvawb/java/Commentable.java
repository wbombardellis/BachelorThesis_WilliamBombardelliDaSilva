 ...
 * </p>
 * <ul>
 *   <li>{@link de.silvawb.java.Commentable#getLayoutInformations <em>Layout Informations</em>}</li>
 * </ul>
 *
 * @see de.silvawb.java.JavaPackage#getCommentable()
 * @model abstract="true"
 * @generated
 */
public interface Commentable extends EObject {
	 ...
	 * @see de.silvawb.java.JavaPackage#getCommentable_LayoutInformations()
	 ...
	 * <!-- begin-model-doc -->
	 * 
	 *  Finds the <code>de.silvawb.java.ConcreteClassifier</code>
	 *  representing the class with the given classified name.
	 *  
	 *  @param name classified name of the ConcreteClassifier
	 * 
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='return ( de.silvawb.java.ConcreteClassifier) org.eclipse.emf.ecore.util.EcoreUtil.resolve(\n\tde.silvawb.java.get(this).getClassifier(name), this);'"
	 * @generated
	 */
	 ...
	 * 
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='return ( de.silvawb.java.ConcreteClassifier) de.silvawb.java.get(this).getClassifier(name);'"
	 * @generated
	 */
	 ...
	 * <!-- begin-model-doc -->
	 * 
	 *  Finds all <code>de.silvawb.java.ConcreteClassifier</code>
	 ...
	 * 
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='org.eclipse.emf.common.util.EList< de.silvawb.java.ConcreteClassifier> result = new org.emftext.language.java.util.UniqueEList< de.silvawb.java.ConcreteClassifier>();\nfor( org.eclipse.emf.ecore.EObject classifier : de.silvawb.java.get(this).getClassifiers(packageName, classifierQuery)) {\n\tresult.add(( de.silvawb.java.ConcreteClassifier) org.eclipse.emf.ecore.util.EcoreUtil.resolve(classifier, this));\n}\nreturn result;'"
	 * @generated
	 */
	 ...
	 * <!-- begin-model-doc -->
	 * 
	 *  Finds the <code>de.silvawb.java.Class</code>
	 ...
	 * <!-- begin-model-doc -->
	 * 
	 *  Finds the <code>de.silvawb.java.Interface</code>
	 ...
	 * @generated
	 */
	de.silvawb.java.Class getClassClass();
	 ...
	 * @generated
	 */
	de.silvawb.java.Class getObjectClass();
	 ...
	 * @generated
	 */
	de.silvawb.java.Class getStringClass();
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='de.silvawb.java.Interface annotationClass = ( de.silvawb.java.Interface) org.eclipse.emf.ecore.util.EcoreUtil.resolve(\n\t\tgetConcreteClassifierProxy(\"java.lang.annotation.Annotation\"), this);\norg.eclipse.emf.ecore.EObject resolved = org.eclipse.emf.ecore.util.EcoreUtil.resolve(annotationClass, this);\nif (resolved instanceof de.silvawb.java.Interface) {\n\treturn ( de.silvawb.java.Interface) resolved;\n}\nreturn null;'"
	 * @generated
	 */
