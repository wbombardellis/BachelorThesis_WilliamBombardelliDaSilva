...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SDL2UML Connection Var3 SDL2UML Connection Var3 R1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getConflictCheckForwardActivity <em>Conflict Check Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getConflictCheckMappingActivity <em>Conflict Check Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getConflictCheckBackwardActivity <em>Conflict Check Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getRepairForwardActivity <em>Repair Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl#getRepairBackwardActivity <em>Repair Backward Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl extends
		OperationalRuleImpl implements
		SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1 {
	/**
	 ...
	 * @generated
	 */
	protected SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__ADD_ELEMENT_ACTIVITY,
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__MOVE_ELEMENT_ACTIVITY,
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null
				&& changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CHANGE_ATTRIBUTE_ACTIVITY,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null
				&& transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__TRANSFORM_FORWARD_ACTIVITY,
							oldTransformForwardActivity,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null
				&& transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__TRANSFORM_MAPPING_ACTIVITY,
							oldTransformMappingActivity,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null
				&& transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__TRANSFORM_BACKWARD_ACTIVITY,
							oldTransformBackwardActivity,
	 ...
	 * @generated
	 */
	public void setTransformBackwardActivity(
			Activity newTransformBackwardActivity) {
	...
	public Activity getConflictCheckForwardActivity() {
		if (conflictCheckForwardActivity != null
				&& conflictCheckForwardActivity.eIsProxy()) {
			...
			if (conflictCheckForwardActivity != oldConflictCheckForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CONFLICT_CHECK_FORWARD_ACTIVITY,
							oldConflictCheckForwardActivity,
							conflictCheckForwardActivity));
			}
		}
	 ...
	 * @generated
	 */
	public void setConflictCheckForwardActivity(
			Activity newConflictCheckForwardActivity) {
	...
	public Activity getConflictCheckMappingActivity() {
		if (conflictCheckMappingActivity != null
				&& conflictCheckMappingActivity.eIsProxy()) {
			...
			if (conflictCheckMappingActivity != oldConflictCheckMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CONFLICT_CHECK_MAPPING_ACTIVITY,
							oldConflictCheckMappingActivity,
							conflictCheckMappingActivity));
			}
		}
	 ...
	 * @generated
	 */
	public void setConflictCheckMappingActivity(
			Activity newConflictCheckMappingActivity) {
	...
	public Activity getConflictCheckBackwardActivity() {
		if (conflictCheckBackwardActivity != null
				&& conflictCheckBackwardActivity.eIsProxy()) {
			...
			if (conflictCheckBackwardActivity != oldConflictCheckBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CONFLICT_CHECK_BACKWARD_ACTIVITY,
							oldConflictCheckBackwardActivity,
							conflictCheckBackwardActivity));
			}
		}
	 ...
	 * @generated
	 */
	public void setConflictCheckBackwardActivity(
			Activity newConflictCheckBackwardActivity) {
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null
				&& synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__SYNCHRONIZE_FORWARD_ACTIVITY,
							oldSynchronizeForwardActivity,
	 ...
	 * @generated
	 */
	public void setSynchronizeForwardActivity(
			Activity newSynchronizeForwardActivity) {
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null
				&& synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__SYNCHRONIZE_BACKWARD_ACTIVITY,
							oldSynchronizeBackwardActivity,
	 ...
	 * @generated
	 */
	public void setSynchronizeBackwardActivity(
			Activity newSynchronizeBackwardActivity) {
			...
			if (repairForwardActivity != oldRepairForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__REPAIR_FORWARD_ACTIVITY,
			...
			if (repairBackwardActivity != oldRepairBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__REPAIR_BACKWARD_ACTIVITY,
	 ...
	 * @generated
	 */
	public TGGNode addElement(final EMap<String, Object> parameters)
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				...
				.executeActivity(this.getAddElementActivity(), parametersCopy);

		return (TGGNode) parametersCopy.get("corrConnection");
	}
	 ...
	 * @generated
	 */
	public boolean changeAttributeValues(final TGGNode correspondenceNode,
			final EMap<String, Object> ruleParameters)
			throws TransformationException {
		org.eclipse.emf.common.util.EMap<String, Object> params = new org.eclipse.emf.common.util.BasicEMap<String, Object>(
				ruleParameters.map());

		params.put("corrConnection", correspondenceNode);
	 ...
	 * @generated
	 */
	public boolean moveElement(final TGGNode correspondenceNode,
			final TGGNode oldPreviousCorrespondenceNode,
			final TGGNode newPreviousCorrespondenceNode)
			throws TransformationException {
		org.eclipse.emf.common.util.EMap<String, Object> params = new org.eclipse.emf.common.util.BasicEMap<String, Object>();

		params.put("corrConnection", correspondenceNode);
		params.put("__oldPreviousCorrespondenceNode",
				oldPreviousCorrespondenceNode);
		params.put("__newPreviousCorrespondenceNode",
				newPreviousCorrespondenceNode);
	 ...
	 * @generated
	 */
	public ErrorCodeEnum transformForward(final TGGNode inputTggNode,
			final boolean checkAttributeFormulae,
			final boolean considerAllLhsCorrNodes)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getTransformForwardActivity(), parameters);

		final ErrorCodeEnum errorCode = (ErrorCodeEnum) parameters
				.get("__errorCode");
	 ...
	 * @generated
	 */
	public ErrorCodeEnum transformMapping(final TGGNode inputTggNode,
			final boolean checkAttributeFormulae,
			final boolean considerAllLhsCorrNodes)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getTransformMappingActivity(), parameters);
	 ...
	 * @generated
	 */
	public ErrorCodeEnum transformBackward(final TGGNode inputTggNode,
			final boolean checkAttributeFormulae,
			final boolean considerAllLhsCorrNodes)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getTransformBackwardActivity(),
						parameters);
	 ...
	 * @generated
	 */
	public EList<EObject> conflictCheckForward(final TGGNode inputTggNode)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getConflictCheckForwardActivity(),
						parameters);
		...
		if (returnValue == null) {
			...
			return new org.eclipse.emf.common.util.BasicEList<EObject>(
					returnValue);
		}
	 ...
	 * @generated
	 */
	public EList<EObject> conflictCheckMapping(final TGGNode inputTggNode)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getConflictCheckMappingActivity(),
						parameters);
	 ...
	 * @generated
	 */
	public EList<EObject> conflictCheckBackward(final TGGNode inputTggNode)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getConflictCheckBackwardActivity(),
						parameters);
	 ...
	 * @generated
	 */
	public ErrorCodeEnum synchronizeForward(final TGGNode inputTggNode,
			final boolean checkAttributeFormulae)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getSynchronizeForwardActivity(),
						parameters);
	 ...
	 * @generated
	 */
	public ErrorCodeEnum synchronizeBackward(final TGGNode inputTggNode,
			final boolean checkAttributeFormulae)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getSynchronizeBackwardActivity(),
						parameters);
	 ...
	 * @generated
	 */
	public ErrorCodeEnum repairForward(final TGGNode inputTggNode,
			final boolean checkAttributeFormulae)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getRepairForwardActivity(), parameters);
	 ...
	 * @generated
	 */
	public ErrorCodeEnum repairBackward(final TGGNode inputTggNode,
			final boolean checkAttributeFormulae)
			throws TransformationException {
		...
		((de.mdelab.mltgg.sdl2uml.generated.SDL2UMLOperationalTGG) this
				.getOperationalRuleGroup().getOperationalTGG())
				.executeActivity(this.getRepairBackwardActivity(), parameters);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CONFLICT_CHECK_FORWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckForwardActivity();
			return basicGetConflictCheckForwardActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CONFLICT_CHECK_MAPPING_ACTIVITY:
			if (resolve)
				return getConflictCheckMappingActivity();
			return basicGetConflictCheckMappingActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__CONFLICT_CHECK_BACKWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckBackwardActivity();
			return basicGetConflictCheckBackwardActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeBackwardActivity();
			return basicGetSynchronizeBackwardActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__REPAIR_FORWARD_ACTIVITY:
			if (resolve)
				return getRepairForwardActivity();
			return basicGetRepairForwardActivity();
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1__REPAIR_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___ADD_ELEMENT__EMAP:
			return addElement((EMap<String, Object>) arguments.get(0));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0),
					(EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___MOVE_ELEMENT__TGGNODE_TGGNODE_TGGNODE:
			return moveElement((TGGNode) arguments.get(0),
					(TGGNode) arguments.get(1), (TGGNode) arguments.get(2));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___TRANSFORM_FORWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformForward((TGGNode) arguments.get(0),
					(Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___TRANSFORM_MAPPING__TGGNODE_BOOLEAN_BOOLEAN:
			return transformMapping((TGGNode) arguments.get(0),
					(Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___TRANSFORM_BACKWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformBackward((TGGNode) arguments.get(0),
					(Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___CONFLICT_CHECK_FORWARD__TGGNODE:
			return conflictCheckForward((TGGNode) arguments.get(0));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___CONFLICT_CHECK_MAPPING__TGGNODE:
			return conflictCheckMapping((TGGNode) arguments.get(0));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___CONFLICT_CHECK_BACKWARD__TGGNODE:
			return conflictCheckBackward((TGGNode) arguments.get(0));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___SYNCHRONIZE_FORWARD__TGGNODE_BOOLEAN:
			return synchronizeForward((TGGNode) arguments.get(0),
					(Boolean) arguments.get(1));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___SYNCHRONIZE_BACKWARD__TGGNODE_BOOLEAN:
			return synchronizeBackward((TGGNode) arguments.get(0),
					(Boolean) arguments.get(1));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___REPAIR_FORWARD__TGGNODE_BOOLEAN:
			return repairForward((TGGNode) arguments.get(0),
					(Boolean) arguments.get(1));
		case GeneratedPackage.SDL2UML_CONNECTION_VAR3_SDL2UML_CONNECTION_VAR3_R1___REPAIR_BACKWARD__TGGNODE_BOOLEAN:
			return repairBackward((TGGNode) arguments.get(0),
					(Boolean) arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //SDL2UMLConnectionVar3_SDL2UMLConnectionVar3_R1Impl
