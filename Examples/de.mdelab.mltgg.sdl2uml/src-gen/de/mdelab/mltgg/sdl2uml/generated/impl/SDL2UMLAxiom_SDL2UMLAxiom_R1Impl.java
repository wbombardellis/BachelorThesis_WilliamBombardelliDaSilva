...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SDL2UML Axiom SDL2UML Axiom R1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.sdl2uml.generated.impl.SDL2UMLAxiom_SDL2UMLAxiom_R1Impl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SDL2UMLAxiom_SDL2UMLAxiom_R1Impl extends OperationalAxiomImpl
		implements SDL2UMLAxiom_SDL2UMLAxiom_R1 {
	/**
	 ...
	 * @generated
	 */
	protected SDL2UMLAxiom_SDL2UMLAxiom_R1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.SDL2UML_AXIOM_SDL2UML_AXIOM_R1;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__ADD_ELEMENT_ACTIVITY,
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__MOVE_ELEMENT_ACTIVITY,
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__CHANGE_ATTRIBUTE_ACTIVITY,
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__TRANSFORM_FORWARD_ACTIVITY,
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__TRANSFORM_MAPPING_ACTIVITY,
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__TRANSFORM_BACKWARD_ACTIVITY,
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__SYNCHRONIZE_FORWARD_ACTIVITY,
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public TGGNode addElement(final EMap<String, Object> parameters,
			final EList<EObject> leftInputElements,
			final EList<EObject> rightInputElements)
		...
		de.mdelab.mltgg.mote2.TGGNode tggNode = (de.mdelab.mltgg.mote2.TGGNode) parametersCopy
				.get("corrAxiom");

		if (tggNode != null) {
			leftInputElements
					.add((org.eclipse.emf.ecore.EObject) parametersCopy
							.get("blockDiagram"));
			rightInputElements
					.add((org.eclipse.emf.ecore.EObject) parametersCopy
							.get("classDiagram"));
	 ...
	 * @generated
	 */
	public ErrorCodeEnum transformForward(
			final EList<EObject> leftInputElements,
			final EList<EObject> rightInputElements,
		...
		if (errorCode == ErrorCodeEnum.OK) {
			rightInputElements.add((org.eclipse.emf.ecore.EObject) parameters
					.get("classDiagram"));
		}
	 ...
	 * @generated
	 */
	public ErrorCodeEnum transformMapping(
			final EList<EObject> leftInputElements,
			final EList<EObject> rightInputElements,
			final boolean checkAttributeFormulae)
			throws TransformationException {
		...
		if (errorCode == ErrorCodeEnum.OK) {
			rightInputElements.add((org.eclipse.emf.ecore.EObject) parameters
					.get("classDiagram"));
			leftInputElements.add((org.eclipse.emf.ecore.EObject) parameters
					.get("blockDiagram"));
		}
	 ...
	 * @generated
	 */
	public ErrorCodeEnum transformBackward(
			final EList<EObject> leftInputElements,
			final EList<EObject> rightInputElements,
			final boolean checkAttributeFormulae)
			throws TransformationException {
	 ...
	 * @generated
	 */
	public ErrorCodeEnum synchronizeForward(
			final EList<EObject> leftInputElements,
			final EList<EObject> rightInputElements,
			final TGGNode inputTggNode, final boolean checkAttributeFormulae)
			throws TransformationException {
	 ...
	 * @generated
	 */
	public ErrorCodeEnum synchronizeBackward(
			final EList<EObject> leftInputElements,
			final EList<EObject> rightInputElements,
			final TGGNode inputTggNode, final boolean checkAttributeFormulae)
			throws TransformationException {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1___ADD_ELEMENT__EMAP_ELIST_ELIST:
			return addElement((EMap<String, Object>) arguments.get(0),
					(EList<EObject>) arguments.get(1),
					(EList<EObject>) arguments.get(2));
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0),
					(EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1___TRANSFORM_FORWARD__ELIST_ELIST_BOOLEAN:
			return transformForward((EList<EObject>) arguments.get(0),
					(EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1___TRANSFORM_MAPPING__ELIST_ELIST_BOOLEAN:
			return transformMapping((EList<EObject>) arguments.get(0),
					(EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1___TRANSFORM_BACKWARD__ELIST_ELIST_BOOLEAN:
			return transformBackward((EList<EObject>) arguments.get(0),
					(EList<EObject>) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1___SYNCHRONIZE_FORWARD__ELIST_ELIST_TGGNODE_BOOLEAN:
			return synchronizeForward((EList<EObject>) arguments.get(0),
					(EList<EObject>) arguments.get(1),
					(TGGNode) arguments.get(2), (Boolean) arguments.get(3));
		case GeneratedPackage.SDL2UML_AXIOM_SDL2UML_AXIOM_R1___SYNCHRONIZE_BACKWARD__ELIST_ELIST_TGGNODE_BOOLEAN:
			return synchronizeBackward((EList<EObject>) arguments.get(0),
					(EList<EObject>) arguments.get(1),
					(TGGNode) arguments.get(2), (Boolean) arguments.get(3));
		}
...
} //SDL2UMLAxiom_SDL2UMLAxiom_R1Impl
